...
//! `episode_repository`, `media_repository`, `custom_image_repository`) en
//! une seule réponse par écran, pour que le frontend n'ait jamais à
//! enchaîner plusieurs commandes pour afficher une seule page.

use crate::db::repositories::{
    custom_image_repository, episode_repository, media_repository, season_repository,
    title_repository,
};
use crate::db::DbPool;
